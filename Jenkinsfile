...
node('chef13') {
   dest = ''
   env.COOKBOOK_REPO = 'GannettDigital/chef-python'
   env.COOKBOOK_NAME = 'python'
   // If you need to change the instance size for your testing
   // update it in your kitchen.ec2.yml file
   try {
